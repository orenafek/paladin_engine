...
},{"vue3-tree":7}],2:[function(require,module,exports){
...
function clear() {
  ...
  const oldTarget = process.env.NODE_ENV !== 'production' ? (0, _shared.isMap)(target) ? new Map(target) : new Set(target) : undefined; // forward the operation before queueing reactions
...
},{"@vue/shared":5,"_process":8}],3:[function(require,module,exports){
(function (process){(function (){
"use strict";
...
function flushJobs(seen) {
  ...
  const check = process.env.NODE_ENV !== 'production' ? job => checkRecursiveUpdates(seen, job) : _shared.NOOP;
...
function watch(source, cb, options) {
  if (process.env.NODE_ENV !== 'production' && !(0, _shared.isFunction)(cb)) {
...
function defineAsyncComponent(source) {
  ...
  const load = () => {
    ...
    return pendingRequest || (thisRequest = pendingRequest = loader().catch(err => {
      ...
      if (process.env.NODE_ENV !== 'production' && comp && !(0, _shared.isObject)(comp) && !(0, _shared.isFunction)(comp)) {
...
function applyOptions(instance) {
  ...
  if (dataOptions) {
    if (process.env.NODE_ENV !== 'production' && !(0, _shared.isFunction)(dataOptions)) {
      warn(`The data option must be a function. ` + `Plain object usage is no longer supported.`);
    }

    const data = dataOptions.call(publicThis, publicThis);

    if (process.env.NODE_ENV !== 'production' && (0, _shared.isPromise)(data)) {
  ...
  if (computedOptions) {
    for (const key in computedOptions) {
      ...
      if (process.env.NODE_ENV !== 'production' && get === _shared.NOOP) {
...
function normalizePropsOptions(comp, appContext, asMixin = false) {
  ...
  if ((0, _shared.isArray)(raw)) {
    for (let i = 0; i < raw.length; i++) {
      if (process.env.NODE_ENV !== 'production' && !(0, _shared.isString)(raw[i])) {
    ...
    if (process.env.NODE_ENV !== 'production' && !(0, _shared.isObject)(raw)) {
...
const PublicInstanceProxyHandlers = {
  get({
    ...
    if (process.env.NODE_ENV !== 'production' && setupState !== _shared.EMPTY_OBJ && setupState.__isScriptSetup && (0, _shared.hasOwn)(setupState, key)) {
...
function setupStatefulComponent(instance, isSSR) {
  ...
  if (setup) {
    ...
    /* SETUP_FUNCTION */
    , [process.env.NODE_ENV !== 'production' ? (0, _reactivity.shallowReadonly)(instance.props) : instance.props, setupContext]);
    (0, _reactivity.resetTracking)();
    unsetCurrentInstance();
...
function finishComponentSetup(instance, isSSR, skipOptions) {
  ...
  if (process.env.NODE_ENV !== 'production' && !Component.render && instance.render === _shared.NOOP && !isSSR) {
    /* istanbul ignore if */
...
},{"@vue/reactivity":2,"@vue/shared":5,"_process":8}],4:[function(require,module,exports){
(function (process){(function (){
"use strict";
...
},{"@vue/runtime-core":3,"@vue/shared":5,"_process":8}],5:[function(require,module,exports){
...
},{"@vue/runtime-dom":4,"_process":8}],7:[function(require,module,exports){
"use strict";
...
exports.updateNodeById = exports.setNodeById = void 0;
...
const _hoisted_2$3 = /* @__PURE__ */(0, _vue.createVNode)("polyline", {
  points: "9 18 15 12 9 6"
}, null, -1);

function _sfc_render$4(_ctx, _cache) {
  return (0, _vue.openBlock)(), (0, _vue.createBlock)("svg", _hoisted_1$4, [_hoisted_2$3]);
}
...
const _hoisted_2$2 = /* @__PURE__ */(0, _vue.createVNode)("polyline", {
  points: "6 9 12 15 18 9"
}, null, -1);

function _sfc_render$3(_ctx, _cache) {
  return (0, _vue.openBlock)(), (0, _vue.createBlock)("svg", _hoisted_1$3, [_hoisted_2$2]);
}
...
const _hoisted_2$1 = /* @__PURE__ */(0, _vue.createVNode)("line", {
  x1: "18",
  y1: "6",
  x2: "6",
  y2: "18"
...
const _hoisted_3$1 = /* @__PURE__ */(0, _vue.createVNode)("line", {
  x1: "6",
  y1: "6",
  x2: "18",
  y2: "18"
...
function _sfc_render$2(_ctx, _cache) {
  return (0, _vue.openBlock)(), (0, _vue.createBlock)("svg", _hoisted_1$2, [_hoisted_2$1, _hoisted_3$1]);
}
...
const _sfc_main$1 = {
  ...
  setup(props, {
    ...
    const childCount = (0, _vue.computed)(() => {
      var _a;

      return (_a = props.node.nodes) == null ? void 0 : _a.length;
    });
    const checkedChildCount = (0, _vue.computed)(() => {
      var _a;
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_arrow_right = (0, _vue.resolveComponent)("arrow-right");

  const _component_arrow_down = (0, _vue.resolveComponent)("arrow-down");

  const _component_delete_icon = (0, _vue.resolveComponent)("delete-icon");

  const _component_tree_row = (0, _vue.resolveComponent)("tree-row", true);
  ...
  return (0, _vue.openBlock)(), (0, _vue.createBlock)("li", {
    ...
    class: "tree-row-item",
    onClick: _cache[4] || (_cache[4] = (0, _vue.withModifiers)($event => $setup.handleClick($props.node), ["stop"]))
  }, [$props.useIcon ? ((0, _vue.openBlock)(), (0, _vue.createBlock)("div", _hoisted_1$1, [$setup.childCount ? ((0, _vue.openBlock)(), (0, _vue.createBlock)(_vue.Fragment, {
    key: 0
  }, [!$props.node.expanded ? (0, _vue.renderSlot)(_ctx.$slots, "iconActive", {
    key: 0
  }, () => [(0, _vue.createVNode)(_component_arrow_right)]) : (0, _vue.renderSlot)(_ctx.$slots, "iconInactive", {
    key: 1
  }, () => [(0, _vue.createVNode)(_component_arrow_down)])], 64)) : (0, _vue.createCommentVNode)("", true)])) : (0, _vue.createCommentVNode)("", true), (0, _vue.renderSlot)(_ctx.$slots, "checkbox", {
    id: $props.node.id,
    node: $props.node,
    checked: $props.node.checked,
    indeterminate: $props.node.indeterminate
  }, () => [$props.useCheckbox ? (0, _vue.withDirectives)(((0, _vue.openBlock)(), (0, _vue.createBlock)("input", {
    key: 0,
    "onUpdate:modelValue": _cache[1] || (_cache[1] = $event => $props.node.checked = $event),
    type: "checkbox",
    checked: $props.node.checked,
    indeterminate: $props.node.indeterminate,
    onClick: _cache[2] || (_cache[2] = (0, _vue.withModifiers)($event => $setup.onToggleCheckbox($props.node), ["stop"]))
  }, null, 8, ["checked", "indeterminate"])), [[_vue.vModelCheckbox, $props.node.checked]]) : (0, _vue.createCommentVNode)("", true)]), (0, _vue.createVNode)("span", _hoisted_2, (0, _vue.toDisplayString)($props.node.label), 1), $setup.childCount && $props.showChildCount ? (0, _vue.renderSlot)(_ctx.$slots, "childCount", {
    key: 1,
    count: $setup.childCount,
    checkedCount: $setup.checkedChildCount,
    childs: $props.node.nodes
  }, () => [(0, _vue.createVNode)("span", _hoisted_3, (0, _vue.toDisplayString)($setup.childCount), 1)]) : (0, _vue.createCommentVNode)("", true), $props.node && $props.useRowDelete ? ((0, _vue.openBlock)(), (0, _vue.createBlock)("div", {
    key: 2,
    class: "delete-icon",
    onClick: _cache[3] || (_cache[3] = (0, _vue.withModifiers)($event => $setup.removedRow($props.node), ["stop"]))
  }, [(0, _vue.renderSlot)(_ctx.$slots, "deleteIcon", {}, () => [(0, _vue.createVNode)(_component_delete_icon)])])) : (0, _vue.createCommentVNode)("", true)]), $props.node.expanded ? ((0, _vue.openBlock)(), (0, _vue.createBlock)("ul", {
    key: 0,
    class: "tree-list",
    style: {
      gap: `${$props.gap}px`
    }
  }, [((0, _vue.openBlock)(true), (0, _vue.createBlock)(_vue.Fragment, null, (0, _vue.renderList)($props.node.nodes, child => {
    return (0, _vue.openBlock)(), (0, _vue.createBlock)(_component_tree_row, {
      key: child.id,
      ...
      childCount: (0, _vue.withCtx)(({
        count,
        checkedCount,
        childs
      }) => [(0, _vue.renderSlot)(_ctx.$slots, "childCount", {
        count,
        checkedCount,
        childs
      })]),
      iconActive: (0, _vue.withCtx)(() => [(0, _vue.renderSlot)(_ctx.$slots, "iconActive", {}, () => [(0, _vue.createVNode)(_component_arrow_right)])]),
      iconInactive: (0, _vue.withCtx)(() => [(0, _vue.renderSlot)(_ctx.$slots, "iconInactive", {}, () => [(0, _vue.createVNode)(_component_arrow_down)])]),
      deleteIcon: (0, _vue.withCtx)(() => [(0, _vue.renderSlot)(_ctx.$slots, "deleteIcon", {}, () => [(0, _vue.createVNode)(_component_delete_icon)])]),
      checkbox: (0, _vue.withCtx)(({
        node: slotNode,
        checked,
        indeterminate
      }) => [(0, _vue.renderSlot)(_ctx.$slots, "checkbox", {
        id: slotNode.id,
        node: slotNode,
        checked,
        indeterminate
  ...
  }), 128))], 4)) : (0, _vue.createCommentVNode)("", true)], 4);
}
...
const searchNodes = (nodes, searchText) => {
  const getNodes = (result, node) => {
    ...
    if (Array.isArray(node.nodes)) {
      ...
      if (nodes2.length) result.push(__spreadProps(__spreadValues({}, node), {
        nodes: nodes2
      }));
    }
...
const _sfc_main = {
  ...
  setup(props, {
    ...
    (0, _vue.onMounted)(() => emit("update:nodes", initNodes(props.nodes)));
    const filteredData = (0, _vue.computed)(() => {
    ...
    const onToggleCheckbox = node => {
      ...
      emit("nodeClick", __spreadProps(__spreadValues({}, node), {
        checked
      }));
    };
...
const _withId = /* @__PURE__ */(0, _vue.withScopeId)("data-v-4af757df");

(0, _vue.pushScopeId)("data-v-4af757df");
const _hoisted_1 = {
  class: "tree"
};
(0, _vue.popScopeId)();
...
const _sfc_render = /* @__PURE__ */_withId((_ctx, _cache, $props, $setup, $data, $options) => {
  const _component_tree_row = (0, _vue.resolveComponent)("tree-row");

  return (0, _vue.openBlock)(), (0, _vue.createBlock)("div", _hoisted_1, [(0, _vue.createVNode)("ul", {
    class: "tree-list",
    style: {
      gap: `${$props.gap}px`
    }
  }, [((0, _vue.openBlock)(true), (0, _vue.createBlock)(_vue.Fragment, null, (0, _vue.renderList)($setup.filteredData, node => {
    return (0, _vue.openBlock)(), (0, _vue.createBlock)(_component_tree_row, {
      key: node.id,
      ...
      name: "iconActive",
      fn: _withId(() => [(0, _vue.renderSlot)(_ctx.$slots, "iconActive", {}, void 0, true)])
    } : void 0, $props.useIcon ? {
      name: "iconInactive",
      fn: _withId(() => [(0, _vue.renderSlot)(_ctx.$slots, "iconInactive", {}, void 0, true)])
    } : void 0, $props.useRowDelete ? {
      name: "deleteIcon",
      fn: _withId(() => [(0, _vue.renderSlot)(_ctx.$slots, "deleteIcon", {}, void 0, true)])
    } : void 0, $props.showChildCount ? {
      name: "childCount",
      fn: _withId(({
        count,
        checkedCount,
    ...
    } : void 0]), 1032, ["node", "use-checkbox", "use-icon", "use-row-delete", "show-child-count", "indent-size", "gap", "row-hover-background", "set-node", "get-node", "update-node", "expandable", "onDeleteRow", "onNodeClick", "onNodeExpanded", "onToggleCheckbox"]);
  }), 128))], 4)]);
});
...
},{"vue":6}],8:[function(require,module,exports){
