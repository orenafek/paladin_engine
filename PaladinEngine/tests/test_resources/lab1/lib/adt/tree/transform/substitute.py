from PaladinEngine.tests.test_resources.lab1.lib.adt.tree import Tree
from PaladinEngine.tests.test_resources.lab1.lib.adt.tree.transform import TreeTransform
...
if __name__ == '__main__':
    from PaladinEngine.tests.test_resources.lab1.lib.adt.tree.build import TreeAssistant as TA
    from PaladinEngine.tests.test_resources.lab1.lib.adt.tree.search.pattern import TreeTopPattern
